...
= 1.0.1 - April 07 2020 =
* Fix: Search result articles margin

= 1.0 - Mar 29 2020 =
* Fix: Keyboard navigation issue
* Fix: Mobile navigation issue
* Fix: Primary menu search issue
* Fix: Form elements focus design

= 0.2 - Feb 25 2020 =
* Update: Compatibility with Education Hub 2.1
...
Edification Hub WordPress Theme, Copyright 2020 wenthemes.com
Edification Hub is distributed under the terms of the GNU General Public License v2
...
* Slider Image: https://stocksnap.io/photo/LFOKYK5LRE
* All other images are from the parent theme Education Hub
